...
extern "C"
{
	...
	typedef void (* GtiEvaluateCallBack)(GtiModel *model, GtiTensor * output);
	...
	*/
	...
	/*!
		...
		\brief Get an availble GtiDevice object that have required platform name (such as 2801)
	...
	*/
	...
	/*!
		...
		\param[in] mode -- chip mode, emmc, ftdi, or others
	...
	*/
	...
	/*!
		...
		\param[in] device -- A pointer to the GtiDevice object
		\param[in] mode -- device's mode (chip mode), e.g. emmc, ftdi, or others
	...
	*/
	...
	/*!
		...
		\brief This function sends a 224x224x3 byte image data buffer to GTI2801 and extracts 
	...
	*/
	...
	/*!
		...
		\brief This function sends a 224x224x3 byte image data buffer to GTI2801 and extracts the result
	...
	*/
	...
	/*!
		...
		\param[in] DeviceType -- 0=FTDI; 1=eMMC;  2=PCIe
	...
	*/
	...
	/*!
		...
		This function initializes device's SDK library environment. It loads CNN co-efficient filter data to GTI2801 chip.
		\param[in] Device -- A pointer to the device object created by GtiDeviceCreate
		\return -- Always 1
	...
	*/
	...
	/*!
		...
		This function sends a 224x224x3 image data buffer to a device (e.g. a GTI2801 chip).
		Image data buffer contains an image in 8 bit per channel plannar RGB or BGR depending on model.
		Usually models trained by Caffe is BGR, otherwise is RGB.
		\param[in] Device -- A pointer to the device object created by GtiDeviceCreate
	...
	*/
	...
	/*!
		...
		This function sends a 224x224x3 tiled image data buffer to a device (e.g. a GTI2801 chip).
		Image data buffer contains an image in 8 bit per channel plannar RGB or BGR depending on model.
		Usually models trained by Caffe is BGR, otherwise is RGB.
	...
	*/
	...
	/*!
		...
		This function gets output data from a device (e.g. a GTI2801 chip). The output data is 8-bit integer.
		\param[in] Device -- A pointer to the device object created by GtiDeviceCreate
	...
	*/
	...
	/*!
		...
		This function gets output data from the device (e.g. a GTI2801 chip). 
